import { Grid, Toolbar, Tooltip, IconButton, Stack, Button, Typography } from "@mui/material"
import { Save, Download, Undo, Redo, Edit, AutoFixHigh, Rectangle, HighlightAlt, Delete, Publish, Square, SquareOutlined, SelectAll, Schema } from '@mui/icons-material'
            ...
            <Toolbar sx={{boxShadow: 1}} variant='dense'>
                <Grid container direction='row' alignItems='center'>
                    ...
                    <Grid item flexGrow={1}>
                        ...
                        <Tooltip title='What is this Andrew?' arrow children={
                            <IconButton color='primary' children={<Square/>}/>}/>
                        <Tooltip title='What is this Andrew?' arrow children={
                            <IconButton color='primary' children={<SelectAll/>}/>}/>
                        <Tooltip title='Magic Wand' arrow children={
                            <IconButton color='primary' children={<AutoFixHigh/>}/>}/>
                        <Tooltip title='What is this Andrew?' arrow children={
                            <IconButton color='primary' children={<Schema/>}/>}/>
                    </Grid>
                    <Grid item>
