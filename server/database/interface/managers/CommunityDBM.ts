...
export default interface CommunityDBM {
    ...
    /**
     * Gets all data assciated with the community with the given community id in the DBMS.
     * 
     * @remarks
     * 
     ...
     * @remarks
     * 
     * If the given partial Community object contains sufficent data to create a new community in the DBMS, the method creates
     ...
     */
    updateCommunity(communityId: string, community: Partial<Community>): Promise<Community | null>;
